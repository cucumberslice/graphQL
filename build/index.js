...
/**
 * In this tutorial we’re not using a 
 * real-world database. So this db.js 
 * file is going to simulate a database, 
...
/**
 * But, you may be wondering: how does GraphQL 
 * know where get the data? That’s 
 * why we should have a resolvers.js file. 
 * That file tells GraphQL how and where it's 
 * going to fetch the data.
 * 
 * 
 * This resolvers.js file is 
 * going to be the way we provide 
 * the instructions for turning a GraphQL 
 * operation into data.
 */
...
const resolvers = {
  ...
  Mutation: {
    ...
    deleteUser: (parent, {
      ...
      const deleteUsers = _db__WEBPACK_IMPORTED_MODULE_0__["users"].splice(userIndex, 1);
